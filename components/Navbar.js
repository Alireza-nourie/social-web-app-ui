...
import { Bell, LayoutDashboard, Search, UserRound, FolderKanban, CircleUserRound } from 'lucide-react';
              ...
              <a
                ...
                className={`px-3.5 py-2 rounded-full text-[13px] font-medium transition-colors ${
                  idx === 0
                    ...
                    : 'text-neutral-600 dark:text-neutral-300 hover:bg-neutral-100/70 dark:hover:bg-neutral-800'
                }`}
              >
                {item.name}
              </a>
          ...
          <div className="flex-1 mx-2 md:mx-6">
            <div className="hidden md:flex items-center gap-2 px-3.5 py-2 rounded-full border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 focus-within:ring-2 focus-within:ring-red-400/50">
              ...
              <input
                ...
                className="w-full bg-transparent placeholder-neutral-400 focus:outline-none text-neutral-700 dark:text-neutral-200"
              />
            </div>
          </div>
